...
namespace ProductShop.App.Commands.Import
{
    public class ImportXMLCommand : ICommand
    {
        ...
        public ImportXMLCommand(IUserService userService, IProductService productService, ICategoryService categoryService, ICategoryProductService categoryProductService)
        {
        ...
        {
            string path = importFilePath + "categories.xml";

            Category[] categories = importer.DeserializeCategory(path);
        ...
        {
            string path = importFilePath + "products.xml";
            Product[] products = importer.DeserializeProduct(path);
        ...
        {
            string path = importFilePath + "users.xml";

            User[] users = importer.DeserializeUser(path);
